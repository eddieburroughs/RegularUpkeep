...
import type { PropertyType, Profile } from "@/types/database";
    ...
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href={`/app/admin/users/${userId}`}>
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Adding property for {targetUser?.full_name || targetUser?.email || "user"}
          </p>
        </div>
      </div>
        ...
        <CardContent className="flex items-center gap-4 py-4">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700">
              This property will be added to {targetUser?.full_name || targetUser?.email}&apos;s account
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="access_notes"
                placeholder="Gate code, lockbox location, key location..."
            ...
            <div className="space-y-2">
              <Label htmlFor="utility_shutoff_notes">Utility Shutoff Notes (optional)</Label>
              <Textarea
                id="utility_shutoff_notes"
                placeholder="Location of water main, electrical panel, gas shutoff..."
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button type="button" variant="outline" asChild>
                <Link href={`/app/admin/users/${userId}`}>Cancel</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
