...
export default async function ProviderInspectionReportPage({
  params,
}: {
  ...
  if (!user) {
    redirect("/auth/login?redirectTo=/provider/inspection/" + docId);
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        <Button variant="outline" asChild className="flex-1">
          <Link href={`/provider/inspection/${docId}/print`} target="_blank">
