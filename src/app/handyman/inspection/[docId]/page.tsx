...
export default async function HandymanInspectionReportPage({
  params,
}: {
  ...
  if (!user) {
    redirect("/auth/login?redirectTo=/handyman/inspection/" + docId);
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        <Button variant="outline" asChild className="flex-1">
          <Link href={`/handyman/inspection/${docId}/print`} target="_blank">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            {meta.generated.requestIds && meta.generated.requestIds.length > 0 && (
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                <span>{meta.generated.requestIds.length} urgent item(s) flagged</span>
              </div>
            )}
          </CardContent>
        </Card>
