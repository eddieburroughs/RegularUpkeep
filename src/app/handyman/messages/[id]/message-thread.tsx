...
interface HandymanMessageThreadProps {
...
export function HandymanMessageThread({ thread, messages, currentUserId, title }: HandymanMessageThreadProps) {
